								...
								<div class="panel panel-default">
									...
									<div class="panel-body " data-acc-content="demo1">
										<div class="form-group">
											...
											<div class="col-md-7">
												<textarea class="form-control" name="location_map" placeholder="Enter location string for Google map" rows="6"><?php echo $location_map;?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-md-3" for="OtherAmenities">OtherAmenities</label>
											<div class="col-md-7">
