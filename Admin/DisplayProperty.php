<?php
require_once('Controller/SQL/DbConnection.php');
require_once('Controller/SQL/SQLFile.php');
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
							...
							data-url="Controller/json/Properties.json"  data-show-refresh="true" data-show-columns="true" 
							...
							data-sort-order="desc" data-single-select="true" data-click-to-select="true" data-maintain-selected="true">
                                <thead>
                                    <tr>
										...
										<th data-field="ownerName" data-sortable="true">Property Owner Name</th>
										<th data-field="ownerPhone" data-sortable="true">Owner Phone</th>
										<th data-field="propertyRegistrationDate" data-sortable="true">Registration Date</th>
									</tr>
                                </thead>
                            </table>
							<!--<div >
								<div class="col-md-12" >
									<button id="add_cart" class="btn btn-info" >View</button>
									<button id="add_cart" class="btn btn-info" >Edit</button>
									<button id="add_cart" class="btn btn-info" >Delete</button>
								</div>
							</div>-->
                        </div>
                    </div>
