...
INSERT INTO `ad_property_owner_info` VALUES (1,18,'Rana J Singh','9878487875','ranasingh@gmail.com','shimla','2016-07-01 00:00:00');
...
CREATE TABLE `audit_rent` (
  ...
  KEY `RoomID` (`RoomID`),
  CONSTRAINT `audit_rent_ibfk_1` FOREIGN KEY (`RoomID`) REFERENCES `room` (`RoomID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `property` VALUES (2,'Vg Homes','g\'g\'g\'g\'g\'g','hjrtjtrj',415452,'11586383','','Assam','Admin/Property gallery/Himalay/','d','fsdfdsfsd\ndjhfgsjdhgfjsdh\nksdhfksdhfkdsjh\nsdlfhldshfglsdh\ndkjfgsdhgksdjh\nkjgfkshgkshkgjhkghkgjhgkh hgkjhkjdshfksjdhfkjh\ndksfhdkhkdjhkdjhkfj\nkjfdhjkjshfkjhskd\ndskkdjhkjhkj\nf\nfs\ndfs\nfdsfsdfds\nfds\nsf dsfds fds dsf fd fds fds fds fds'),(3,'','','',0,'','','','','',''),(4,'agile','g\\\'g\\\'g\\\'g\\\'g\\\'g','ht',415452,'11586383','','Jammu and Kashmir','../Property gallery/agile/','g','g'),(5,'Vg Homes','g\'g\'g\'g\'g\'g','greg\'greg\'gerhge',415452,'11586383','','Karnataka','../Property gallery/Vg Homes','d','g'),(6,'agile properties','g\'g\'g\'g\'g\'g','greg\'greg\'gerhge',415452,'11586383','','Tripura','../Property gallery/agile properties/','tg','h'),(7,'Welcome apt','jik67k\'rtj\'ytjjjj','jty',415452,'11586383','','Sikkim','../Property gallery/Welcome apt/','yh','h'),(9,'mobile villa','hnj\'htrjh','greg\'greg\'gerhge',415452,'11586383','','Uttaranchal','Admin/Property gallery/mobile villa/','fc','rf'),(10,'nmbs','nghngn','hjrtjtrj',415452,'11586383','','Jharkhand','Admin/Property gallery/nmbs/','f','g'),(15,'Ganesh','rhrtj','jytj',457891,'9987452552','','Maharashtra','Admin/Property gallery/Ganesh/','yutru','ytity'),(16,'Grand Hotel','Street','City',415452,'11586383','','Jammu and Kashmir','Admin/Property gallery/Grand Hotel/','Map Location','Description'),(17,'parl','lii','lili',0,'11586383','5','Jammu and Kashmir','Admin/Property gallery/parl/','gf','rg'),(18,'Himalay','jytjyuk','Shimla',488457,'9685741425','5','Himachal Pradesh','Admin/Property gallery/Himalay/','google location string','amazing hotel that u cant find in shimla');
...
INSERT INTO `property_info` VALUES (15,'ytity','ury','Yes','urturt','ureuru','rturtu','uryirt','urturt','urdurdu','urtu'),(16,'Bedrooms','Bathrooms','No','Meals','EntertainMent','OtherAmenities','Theme','Attractions','Leisure Activitie','General'),(17,'grfe','erg','Yes','reg','reg','reg','reg','reg','erg','reg'),(18,'u','jy','Yes','uuykuyt,j56,j5,j5,j5uj,,uj56,ju','u54her,h.erherh,erwrh,erwhew','y5yhu45,hre,hre,he,herh','hth,4h,4,hh5h','h,4,h4h,56,56','rewgerwhgreg','ghreh');
...
-- Dump completed on 2016-01-12 18:11:45
