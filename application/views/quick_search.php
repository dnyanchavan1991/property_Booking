...
<section class="rooms mt100">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12" style="border-bottom:2px solid lightgrey;margin-bottom:20px;">
                <h3>Best Deals found : 17 rentals</h3>
            </div>
            <!-- Room -->
            <div class="col-sm-4">
                <div class="room-thumb" style="padding-bottom:10px"> <img src="<?php echo base_url() ?>assets/images/holidays_img/5.jpg" alt="room 1" class="img-responsive" />
                    <div class="mask">
                        <div class="main">
                            <h5>Agintha</h5>
