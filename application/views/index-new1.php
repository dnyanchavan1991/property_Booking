    ...
    <div class="container">
      ...
      <div id="navbar-collapse-grid" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
		 ...
		 <!-- <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle js-activated">Featured<b class="caret"></b></a>
            <ul class="dropdown-menu">
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="images\holidays_img\5.jpg" alt="room 1" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Agintha</h5>
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="images\holidays_img\11.jpg" alt="room 2" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>King Palace </h5>
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="images\holidays_img\10.jpg" alt="room 3" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Vrundavan</h5>
