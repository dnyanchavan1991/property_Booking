...
<script type="text/javascript">
		...
		var mobno=document.formData.phone.value;
		var text=document.formData.enquiry.value;
		var xmlHttp = new XMLHttpRequest();
	
   xmlHttp.open( "GET", "http://bhashsms.com/api/sendmsg.php?user=8796151636&pass=tabrez&sender=KDHLTH&phone="+mobno+"&text="+text+"&priority=sdnd&stype=normal", false ); 
    xmlHttp.send( null );
	 }
	else
...
<div class="rooms text-center">
  <div class="container">
    <h2 class="tittle-one"> <?php echo $propertyName;  ?>
    ...
    <div class="room-detail">
            ...
            <div class="contact-form detailed-contact-form">
              <form id="reviewForm" name="reviewForm" ng-submit="processForm()">
                ...
                <div class="acidjs-rating-stars">
                  <input style="margin-right: 5px" type="radio" ng-model="rating_given" id="group-2-0" value="5" />
                  <label style="font-weight: normal" for="group-2-0">Excellent</label>
                  &nbsp;&nbsp;
                  <input style="margin-right: 5px" type="radio" ng-model="rating_given" id="group-2-1" value="4" />
                  <label style="font-weight: normal" for="group-2-1">Very Good</label>
                  &nbsp;&nbsp;
                  <input style="margin-right: 5px" type="radio" ng-model="rating_given" id="group-2-2" ng-init="rating_given=3" ng-selected="true" value="3" />
                  <label style="font-weight: normal" for="group-2-2">Good</label>
                  &nbsp;&nbsp;
                  <input style="margin-right: 5px" type="radio" ng-model="rating_given" id="group-2-3" value="2" />
                  <label style="font-weight: normal" for="group-2-3">Average</label>
                  &nbsp;&nbsp;
                  <input style="margin-right: 5px" type="radio" ng-model="rating_given" id="group-2-4" value="1" />
                  <label style="font-weight: normal" for="group-2-4">Bad</label>
                </div>
            ...
            <div class="other-comments"   data-ng-init = "getReviews()" >
              <div class="comments-head">
                ...
                <div class="comments-bot" dir-paginate="reviews_count in reviews|itemsPerPage:10">
                  <div class="col-sm-2 customer-name"> <strong>{{reviews_count.customer_name}} </strong><br/>
                    <span class="review-star" ng-repeat="r_cnt in strtoint(reviews_count.star_rating)">★</span> </div>
                  <div class="col-sm-10 review-details">
                    <div class="visited-during"> <strong> Visited property during {{reviews_count.check_in}} - {{reviews_count.check_out}}</strong> </div>
                    <div class="review">
      ...
      <div class="booking-grid col-sm-3">
        ...
        <div class="hotel-left-two" ng-app="getRoomDetailApp" ng-controller="popupController">
          <p> Send </p>
          <a class = "send-mail" href="#send-form" >Email</a> | <a class = "send-sms" href="#send-form">SMS</a>
          <div id="send-form" class="zoom-anim-dialog mfp-hide">
            <form id="mail-sms-form" novalidate="novalidate" name="formData" method="post" class="enquiry-form contact-form detailed-contact-form" ng-submit="">
              ...
              <div class="" id="inTime">
                ...
                <input class="date" placeholder="CheckIn Date" autocomplete="false"
              ...
              <div class="" id="outTime">
                ...
                <input class="date" placeholder="CheckOut Date" autocomplete="false"
              ...
              <br>
              <input style="width: 32% !important;" type="submit" id="submit_div" value="Submit" onClick="sendSms()">
            </form>
            <script>
                                $(function() {
