		...
		<div class="container">
			<div class="navbar-header">
				...
				<a href="<?php echo base_url() ?>" class="navbar-brand">
					<!-- Logo -->
					<div id="logo" style="margin-top: 8px;height: 60px !important;width: 180px !important;padding-top:0px">
					<img id="default-logo" src="<?php echo base_url()?>images/F3.jpg" alt="HOLIDAYBAY" style="height: 4em; width: 15em"><!--style="height:100%;width:100%"--> </div>
				</a> </div>
