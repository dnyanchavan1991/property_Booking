...
<section id="reservation-form">
  <div class="container">
    <div class="row">
      <div class="col-md-12" >           
        <form class="form-inline reservation-horizontal clearfix" role="form" method="post" action="php/reservation.php" name="reservationform" id="reservationform" style="box-shadow: 0px 5px 10px 1px ;">
        <div id="message"></div><!-- Error message display -->
          <div class="row" >
            <div class="col-sm-3">
              <div class="form-group" >
                <label for="email" accesskey="E">Location</label>
                <input name="email" type="text" id="email" value="" class="form-control" placeholder="Please enter your Location"/>
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
...
<section class="gallery-slider mt100">
  ...
  <div id="owl-gallery" class="owl-carousel" style="box-shadow: 0px 0px 3px 2px #494949;">
    <div class="item" >
    	<div class="col-sm-4" >
	    	<div class="room-thumb" style="box-shadow: 0px 0px 1px 1px #494949;"> <img src="css/css/images\holidays_img\10.jpg" alt="room 3" class="img-responsive" data-rel="prettyPhoto[gallery2]"/>
	          <div class="mask">
	            <div class="main" style="background: #494949;">
	              <h5 style="color:#fff;">Vrundavan</h5>
    ...
    <div class="item">
    	 <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb" style="box-shadow: 0px 0px 1px 1px #494949;"> <img src="css/css/images\holidays_img\5.jpg" alt="room 1" class="img-responsive" data-rel="prettyPhoto[gallery2]"/>
          <div class="mask">
            <div class="main">
              <h5>Agintha</h5>
    ...
    <div class="item">
    	<a href="css/css/images/gallery/800x504.gif" data-rel="prettyPhoto[gallery2]"><img src="images/gallery/800x504.gif" alt="Image 3"><i class="fa fa-search"></i></a>
    </div>
    <div class="item"><a href="css/css/images/gallery/800x504.gif" data-rel="prettyPhoto[gallery2]"><img src="images/gallery/800x504.gif" alt="Image 4"><i class="fa fa-search"></i></a></div>
    <div class="item"><a href="css/css/images/gallery/800x504.gif" data-rel="prettyPhoto[gallery2]"><img src="images/gallery/800x504.gif" alt="Image 4"><i class="fa fa-search"></i></a></div>
  </div>
</section>
</div>
