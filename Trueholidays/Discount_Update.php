                                    ...
                                    <hr>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="txttotalcost" class="form-control" value="<?php echo $row[7];?>" id="totalcost" placeholder="" required="true"  readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 col-md-offset-1 control-label" for="example-email">Discount :</label>
                                                <div class="col-md-6">
                                                   <input type="text" placeholder="" name="txtdiscount"  class="form-control" required="true"  onkeyup="calculate(this.value);">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 col-md-offset-1 control-label" for="example-email">Final Total :</label>
                                                <div class="col-md-6">
                                                   <input type="text" placeholder="" name="txtfinalcost"  class="form-control" required="true"  id="finalcost" readonly="true">
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                 <label class="col-md-3 col-md-offset-1 control-label" for="example-email"> Date:</label>
                                                <div class="col-md-6">
                                                   <input type="text" name="txtsubmitteddate" value="<?php date_default_timezone_set("Asia/Kolkata"); echo date("Y-m-d");?>"
                                                    class="form-control" required="true" readonly>
                                                </div>
                                            </div>
                               				  ...
                               				  <div class="form-group">
                                                <center>
                                                    <button type="submit" name="addDiscount" class="btn btn-primary waves-effect waves-light">
                                                        Save 
                                                    </button>
                                                </center>
                                            </div>
