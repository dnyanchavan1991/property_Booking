...
--
-- Host: localhost
-- Generation Time: Jan 26, 2016 at 02:44 PM
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `logged_in_dateTime` varchar(100) NOT NULL
...
(28, 'Ganesh Kripa', 'Hadapsar', 'Pune', 411028, '1', 'Maharashtra', 'Property gallery/Ganesh Kripa/', '', 'kajshgfjahsgf', '', 'Bungalow'),
(29, 'Ganesh Kripa', 'Hadapsar', 'Pune', 411028, '1', 'Maharashtra', 'Property gallery/Ganesh Kripa/', '', 'kajshgfjahsgf', '', 'Bungalow');
