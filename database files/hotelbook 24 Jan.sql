...
--
-- Host: localhost
-- Generation Time: Jan 24, 2016 at 11:25 PM
...
(2, 'Grand Park', 'pune benglore Highway', 'pUNE', 415452, '5', 'Maharashtra', 'Admin/Property gallery/Himalay/', 'd', 'Generally Hotel Information sheet is kept on all guest rooms.\r\n\r\nThis helps to give an overview of all services and facilities provided by the hotel to the guests. \r\n\r\nAnd this sheet also contains the details and timing of in-house Restaurants, Spa etc. along with the direct extension number for Reception, Housekeeping and Room Service.\r\n\r\nGenerally Hotel Information sheet is kept on all guest rooms, This helps to give an overview of all services and facilities provided by the hotel to the guests. And this sheet also contains the details and timing of in-house Restaurants, Spa etc. along with the direct extension number for Reception, Housekeeping and Room Service.\r\n\r\nContact on 123456 for more information', 'By bus-get katraj bus from swargate\nBy Railway-no railway available \nBy Auto -u will get auto from anywhere', 'Villa'),
(3, '', '', '', 0, '', '', '', '', '', NULL, NULL),
...
(19, 'VIsh Property', 'pune', 'pune', 411028, '5', 'Madhya Pradesh', 'Property gallery/VIsh Property/', '', 'sdsa asd\r\nasd\r\nasd\r\nasd\r\n<b> ahd</b>\r\n\r\nthanks.\r\nVIshwnatah Awate\r\n', 'by road -\r\n\r\nasdljkha skdjh askjdh aksjhd kasjhd as\r\nd\r\n\r\n\r\n\r\nby air - \r\nakjsdh aksjhd as\r\nd \r\nask dasj dklas jd\r\na;s djdlasjhd lasjk dkasjd kasjd sd 12437982374 b23o523 5y2\r\n\r\nby train -\r\nasldj sdkf87045 34jthkrejnhg fdj hgjfd h978 y439tjrehng\r\n', 'Row House');
...
CREATE TABLE IF NOT EXISTS `property_info` (
  ...
  `in_house_kitchen` varchar(10) NOT NULL,
...
INSERT INTO `property_info` (`property_id`, `bedrooms`, `bathrooms`, `pool`, `meals`, `internet_access`, `smoking_allowd`, `television_access`, `pet_friendly`, `air_condition`, `entertainment`, `other_amenities`, `theme`, `attractions`, `leisureActivities`, `general`, `payment_facility`, `in_house_kitchen`) VALUES
(2, '10', '2', 'Yes', 'vegiterian/nonvarg', 'Yes', 'No', 'YES', 'YES', 'Yes', 'katputli dramma', 'dance,plo club', 'rajwada', 'mohol bridge', '', '', 'No', ''),
(15, '3', '3', 'Yes', 'only non veg', 'No', 'No', 'Yes', 'Yes', 'Yes', 'reg', 'reg', 'marwadi', 'reg', 'erg', 'reg', 'No', ''),
(16, '5', '5', 'No', 'vegiterian', 'No', 'No', 'Yes', 'Yes', 'Yes', 'EntertainMent', 'OtherAmenities', 'Theme', 'Attractions', 'Leisure Activitie', 'General', 'No', ''),
(18, 'u', 'jy', 'Yes', 'uuykuyt,j56,j5,j5,j5uj,,uj56,ju', NULL, NULL, NULL, NULL, NULL, 'u54her,h.erherh,erwrh,erwhew', 'y5yhu45,hre,hre,he,herh', 'hth,4h,4,hh5h', 'h,4,h4h,56,56', 'rewgerwhgreg', 'ghreh', 'NO', '');
...
INSERT INTO `visitors_info` (`visitor_id`, `visitor_ip`, `city`, `region`, `country`, `date_visited`, `location`, `Service_Provider`) VALUES
(60, '223.196.18.240', 'Hyderabad', 'Telangana', 'IN', '2016-01-24', '17.3753,78.4744', 'AS55644 Idea Cellular Limited');
